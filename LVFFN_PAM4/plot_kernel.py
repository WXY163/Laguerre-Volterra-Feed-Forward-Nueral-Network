...
plot_h1(h1)
plot_h2(h2,R)
h3ave = calculate_h3ave(h3,R)
#np.savetxt('kernels/h3ave.csv',h3ave,delimiter = ',')
#plot_h2(h2ana)
plot_h2(h3ave,R)
"""
Xm = Xm[:,::-1]
output_Y = h0 + conv1(h1,Xm[1000:],2000)+conv2(h2,Xm[1000:],2000,memory)+conv3(h3,Xm[1000:],2000,memory)
#output_Y = conv2(h2,Xm,1000,memory)

plt.plot(Y_label[1000:3000])
plt.plot(output_Y[:2000])
"""
plt.show()
